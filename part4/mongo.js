...
if(process.argv.length===6){
  ...
  blog.save().then(result => {
    console.log(`Added the blog title ${result.title} and with the author ${result.author} and link to the url ${result.url} and with this many likes ${result.likes} to the blogs`)
    mongoose.connection.close()
  })
}